...
from .loading import LoadPairedImageFromFile
from .transforms import PairedImagesResize, PairedImagesRandomCrop, PairedImagesRandomFlip, PairedImagesPad, PairedImagesNormalize
from .formatting import PairedImagesDefaultFormatBundle
from .transforms import AutoAugmentCustom, PairedImagesAutoAugmentCustom
from .transforms import Stitch
__all__ += ['LoadPairedImageFromFile', 'PairedImagesResize', 'PairedImagesRandomCrop', 'PairedImagesRandomFlip', 
'PairedImagesPad', 'PairedImagesNormalize', 'PairedImagesDefaultFormatBundle', 'AutoAugmentCustom', 'PairedImagesAutoAugmentCustom', 'Stitch']
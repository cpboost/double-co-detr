...
PROCESS = Registry('process')  # clw note: for LaneATT TODO
OBJECTSAMPLERS = Registry('Object sampler')  # clw note: for mmdet3d TODO
...
def build_dataloader_onemodel(dataset,
                     samples_per_gpu,
                     workers_per_gpu,
                     num_gpus=1,
                     dist=True,
    ...
    if runner_type == 'IterBasedRunner':
        ...
        ###################################################
            ...
            if isinstance(dataset, IterableDataset):  # clw modify: TODO
                sampler = None
            else:
    ...
    data_loader = [DataLoader(
        ...
        pin_memory=kwargs.pop('pin_memory', False),
        worker_init_fn=init_fn,
        **kwargs) for ds in dataset.datasets]
